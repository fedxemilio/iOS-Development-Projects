...
func checkUserAge(_ input: String) -> Int? {
    let userAge: Int? = Int(input)
    if let age = userAge {
        if age >= 18 {
            print("Welcome!")
            return age
...
print(checkUserAge("wheio"))
print(checkUserAge("18"))
...
func buyItem(itemName: String) -> Double? {
...
print(buyItem(itemName: "Chips"))
print(buyItem(itemName: "Therapy"))
/*:
