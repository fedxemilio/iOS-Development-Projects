...
var thisCasket = Rectangle(width: 10, height: 20)
print(thisCasket.area)
/*:
...
print("Old Height: \(myHeight.heightInCentimeters)")
myHeight.heightInInches = 75
print("New height: \(myHeight.heightInCentimeters)")
