...
var emilio = User(name: "Emilio", age: 28, height: 190, weight: 195, activityLevel: 4)
print("\(emilio.name), age \(emilio.age), height: \(emilio.height)cm, weight: \(emilio.weight)km has an activity level of \(emilio.activityLevel).")
/*:
