...
let favoriteBook = Book(title: "O Alquimista", author: "Paolo Coelho", pages: 152, price: 15.0)
print("\(favoriteBook.title) by \(favoriteBook.author) is \(favoriteBook.pages) pages long and costs $\(favoriteBook.price)")
/*:
...
var laptop1 = Laptop(repairCount: 2, yearPurchased: 2013)
...
var myHeight = Height(heightInCentimeters: 190)
print(myHeight.heightInInches)
myHeight = Height(heightInInches: 75)
