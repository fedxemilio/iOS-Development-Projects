...
func progressUpdate(steps: Int, goal: Int) {
    if steps < goal / 10 {
        ...
        print("You're almost halfways there!")
...
progressUpdate(steps: 500, goal: 200)
progressUpdate(steps: 220, goal: 300)
progressUpdate(steps: 10, goal: 11)
progressUpdate(steps: 300, goal: 1000)
...
func pacing(currentDistance: Double, totalDistance: Double,
    ...
    let percentOfTimeLeft = currentTime / goalTime
    if percentComplete >= percentOfTimeLeft {
        print("Keep it up!")
    } else {
